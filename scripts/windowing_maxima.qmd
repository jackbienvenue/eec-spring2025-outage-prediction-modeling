...
#####-----FUNCTION PHASE 2: USE WINDOWING TO MAXIMIZE DRIVER VALUES-----#####
    ...
    def window_maximizer_helper(weather_data, storm_start_datetime):
        ...
        ## Identify maximum
        max_wind_velo = weather_data_without_first['wind_velo'].max()
        ...
        weather_data['hourly_precip'] = weather_data.apply(
            lambda row: row['tp'] if row['day_change'] else row['hourly_precip'], axis=1)
        ...
        max_precip_intensity = weather_data_without_first['precip_intensity'].max()
...
#####-----   FUNCTION PHASE 3: DEFINING OUTPUTS   -----#####
    ...
    # Define empty dataframe to store driver-maximized events
    driver_maximized_events = pd.DataFrame
    ...
    for row in event_df.iterrows(): 
        ...
        driver_maximized_events = driver_maximized_events.append(maximized_driver_event)
