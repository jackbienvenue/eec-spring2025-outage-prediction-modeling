...
#####-----   FUNCTION PHASE 2: USE WINDOWING TO MAXIMIZE DRIVER VALUES   -----#####
    ...
    collapsed_data = town_outages.groupby('storm_start_datetime')['town'].apply(lambda towns: ', '.join(towns)).reset_index()
    collapsed_data.rename(columns={'town': 'towns_affected'}, inplace=True)
    ...
    for event in gdf.itertuples():  # Use itertuples for better performance
        ...
        for pseudo_day in range(24):  # Loop through pseudo-days (0 to 23)
            ...
            means = pseudo_day_data[['var1', 'var2', 'var3']].mean()  # Assuming 'var1', 'var2', etc. are your independent variables
