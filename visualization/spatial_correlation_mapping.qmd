...
def build_driver_correlation_map(driver1, driver2, shapefile_directory, input_directory, save_to_file = False, output_directory = None):
    ...
    def extract_lat_lon_from_filename(filename):
        ...
        lat_match = re.search(r"lat_([\d\.\-]+)_", filename)
        lon_match = re.search(r"lon_([\d\.\-]+)_", filename)
    ...
    ## Step 3: Load CSVs and iteratively calculate correlation
    ...
    merged = gpd.sjoin(shapefile, correlation_gdf, how="left", op="intersects")
    ...
    # Add a colorbar to the plot for the correlation scale
    sm = plt.cm.ScalarMappable(cmap=cmap, norm=plt.Normalize(vmin=-1, vmax=1))
    sm.set_array([])  # Use this for colorbar
...
build_driver_correlation_map("avg_wind_speed", "total_precipitation", "/Users/jackbienvenuejr/Desktop/EEC_Work/weather-driver-independence-evaluation/data/grid_cell_shapefile", "/Volumes/JB_Fortress_L3/EEC/aggregated_csvs")
```